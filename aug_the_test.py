...
class MediumAug1():
    def __init__(self, n_augs):
        train_source = list(list(pd.read_csv('top_out_55.csv')["ca_productions"]))
        train_targs = list(list(pd.read_csv('top_out_55.csv')["ca_reactants"]))
        train_type = list(list(pd.read_csv('top_out_55.csv')["top_10_classes"]))
